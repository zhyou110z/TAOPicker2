...
//			TmpSock = btDevice.createRfcommSocketToServiceRecord(UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"));
			...
			TmpSock =(BluetoothSocket) btDevice.getClass().getMethod("createRfcommSocket", new Class[] {int.class}).invoke(btDevice,1);
		}
		catch (Exception ex) 
		{
			TmpSock = null;
	...
	{
		Log.e(Constant.PRINT_TAG, "-----------begin----------");
		String str = "";
		for(int i=0; i<buffer.length; i++){
			str += buffer[i]+",";
		}
		Log.e(Constant.PRINT_TAG, str);
		Log.e(Constant.PRINT_TAG, "------------end-----------");
