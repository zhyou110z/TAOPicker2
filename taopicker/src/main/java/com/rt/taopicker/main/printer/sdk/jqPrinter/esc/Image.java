...
import com.rt.taopicker.main.printer.sdk.jqPrinter.common.ImageConvert;
...
public class Image extends BaseESC {
	...
	public boolean drawOut(int x, int y, Bitmap bitmap) 
	{
		...
		Log.e(Constant.PRINT_TAG, "width:" + width);
		Log.e(Constant.PRINT_TAG, "height:" + height);
		...
		Log.e(Constant.PRINT_TAG, "data:" + dataStr);
