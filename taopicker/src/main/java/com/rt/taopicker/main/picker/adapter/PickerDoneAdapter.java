...
public class PickerDoneAdapter extends BaseAdapter {
    ...
    public PickerDoneAdapter(Activity activity, Context context, List<GoodInfoEntity> data, GoodItemClickListener itemClickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.picker_done_good_info_item, parent, false);
        ...
        if(goodInfo.getProductType()==1 || goodInfo.getProductType()==2){ //标品或按件称重
            ...
            holder.productPcs.setText("x"+goodInfo.getProductDonePcs());
