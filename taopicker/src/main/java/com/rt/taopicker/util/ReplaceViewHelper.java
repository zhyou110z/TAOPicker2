...
/**
 * Created by yaoguangyao on 2017/9/8.
 */
...
public class ReplaceViewHelper {
    ...
    private static ReplaceViewHelper sInstance;

    public static ReplaceViewHelper getInstance() {
        if (sInstance == null) {
            sInstance = new ReplaceViewHelper();
        }
        return sInstance;
    }
    ...
    public ReplaceViewHelper toReplaceView(View targetView, final int replaceViewResId) {
        toReplaceView(targetView, View.inflate(BaseApplication.sContext, replaceViewResId, null));
        return this;
    }
